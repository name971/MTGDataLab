...
const sampleFormatData: FormatData = {
  format: "Modern",
  archetypes: [
    {
      Name: "Rakdos Scam",
...
const sampleDeck: Deck = {
  mainboard: [
    ...
    { name: "Thoughtseize", count: 3 },
  ],
  sideboard: [{ name: "Surgical Extraction", count: 2 }],
};

// console.log(classifyDeck(sampleDeck, sampleFormatData));
// → { archetype: 'Rakdos Scam', matchedBy: 'rule', matchedConditions: [...] }
